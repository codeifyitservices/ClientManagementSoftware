...
// 1. GET /api/subscriptions - Fetch all subscriptions
...
// 2. GET /api/subscriptions/alerts - Get all active undismissed alerts
...
// 3.5 POST /api/subscriptions/bulk-delete - Bulk delete subscriptions
...
// 5. DELETE /api/subscriptions/:id - Delete subscription
...
// 6. POST /api/subscriptions/:id/dismiss-alert - Dismiss/Acknowledge an active app alert
router.post("/:id/dismiss-alert", async (req, res) => {
  try {
...
// 7. POST /api/subscriptions/run-check - Manual trigger for testing emails
...
// 8. POST /api/subscriptions/:id/send-email - Manually send reminder email to client
